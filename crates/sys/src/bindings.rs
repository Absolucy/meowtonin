...
pub struct ByondApi {
	...
	pub Byond_LastError:
		unsafe extern "C-unwind" fn(buf: *mut ::std::os::raw::c_char, buflen: *mut u4c) -> bool,
	...
	pub Byond_CreateListLen:
		unsafe extern "C-unwind" fn(result: *mut CByondValue, len: u4c) -> bool,
	pub Byond_CreateDimensionalList: unsafe extern "C-unwind" fn(
		result: *mut CByondValue,
		sizes: *const u4c,
		dimension: u4c,
	) -> bool,
	...
	pub Byond_ListRemove: unsafe extern "C-unwind" fn(
		loc: *const CByondValue,
		items: *const CByondValue,
		count: u4c,
	) -> u4c,
...
impl ByondApi {
		...
		L: Into<::libloading::Library>,
	{
		...
		let Byond_LastError = __library.get(b"_Byond_LastError\0").map(|sym| *sym)?;
		let Byond_SetLastError = __library.get(b"_Byond_SetLastError\0").map(|sym| *sym)?;
		let Byond_GetVersion = __library.get(b"_Byond_GetVersion\0").map(|sym| *sym)?;
		let Byond_GetDMBVersion = __library.get(b"_Byond_GetDMBVersion\0").map(|sym| *sym)?;
		let ByondValue_Clear = __library.get(b"_ByondValue_Clear\0").map(|sym| *sym)?;
		let ByondValue_Type = __library.get(b"_ByondValue_Type\0").map(|sym| *sym)?;
		let ByondValue_IsNull = __library.get(b"_ByondValue_IsNull\0").map(|sym| *sym)?;
		let ByondValue_IsNum = __library.get(b"_ByondValue_IsNum\0").map(|sym| *sym)?;
		let ByondValue_IsStr = __library.get(b"_ByondValue_IsStr\0").map(|sym| *sym)?;
		let ByondValue_IsList = __library.get(b"_ByondValue_IsList\0").map(|sym| *sym)?;
		let ByondValue_IsTrue = __library.get(b"_ByondValue_IsTrue\0").map(|sym| *sym)?;
		let ByondValue_GetNum = __library.get(b"_ByondValue_GetNum\0").map(|sym| *sym)?;
		let ByondValue_GetRef = __library.get(b"_ByondValue_GetRef\0").map(|sym| *sym)?;
		let ByondValue_SetNum = __library.get(b"_ByondValue_SetNum\0").map(|sym| *sym)?;
		let ByondValue_SetStr = __library.get(b"_ByondValue_SetStr\0").map(|sym| *sym)?;
		let ByondValue_SetStrId = __library.get(b"_ByondValue_SetStrId\0").map(|sym| *sym)?;
		let ByondValue_SetRef = __library.get(b"_ByondValue_SetRef\0").map(|sym| *sym)?;
		let ByondValue_Equals = __library.get(b"_ByondValue_Equals\0").map(|sym| *sym)?;
		let ByondValue_Equiv = __library.get(b"_ByondValue_Equiv\0").map(|sym| *sym)?;
		let Byond_ThreadSync = __library.get(b"_Byond_ThreadSync\0").map(|sym| *sym)?;
		let Byond_GetStrId = __library.get(b"_Byond_GetStrId\0").map(|sym| *sym)?;
		let Byond_AddGetStrId = __library.get(b"_Byond_AddGetStrId\0").map(|sym| *sym)?;
		let Byond_ReadVar = __library.get(b"_Byond_ReadVar\0").map(|sym| *sym)?;
		let Byond_ReadVarByStrId = __library.get(b"_Byond_ReadVarByStrId\0").map(|sym| *sym)?;
		let Byond_WriteVar = __library.get(b"_Byond_WriteVar\0").map(|sym| *sym)?;
		let Byond_WriteVarByStrId = __library.get(b"_Byond_WriteVarByStrId\0").map(|sym| *sym)?;
		let Byond_CreateList = __library.get(b"_Byond_CreateList\0").map(|sym| *sym)?;
		let Byond_CreateListLen = __library.get(b"_Byond_CreateListLen\0").map(|sym| *sym)?;
		let Byond_CreateDimensionalList = __library
			.get(b"_Byond_CreateDimensionalList\0")
			.map(|sym| *sym)?;
		let Byond_ReadList = __library.get(b"_Byond_ReadList\0").map(|sym| *sym)?;
		let Byond_ReadListAssoc = __library.get(b"_Byond_ReadListAssoc\0").map(|sym| *sym)?;
		let Byond_WriteList = __library.get(b"_Byond_WriteList\0").map(|sym| *sym)?;
		let Byond_ReadListIndex = __library.get(b"_Byond_ReadListIndex\0").map(|sym| *sym)?;
		let Byond_WriteListIndex = __library.get(b"_Byond_WriteListIndex\0").map(|sym| *sym)?;
		let Byond_ListRemove = __library.get(b"_Byond_ListRemove\0").map(|sym| *sym)?;
		let Byond_ReadPointer = __library.get(b"_Byond_ReadPointer\0").map(|sym| *sym)?;
		let Byond_WritePointer = __library.get(b"_Byond_WritePointer\0").map(|sym| *sym)?;
		let Byond_CallProc = __library.get(b"_Byond_CallProc\0").map(|sym| *sym)?;
		let Byond_CallProcByStrId = __library.get(b"_Byond_CallProcByStrId\0").map(|sym| *sym)?;
		let Byond_CallGlobalProc = __library.get(b"_Byond_CallGlobalProc\0").map(|sym| *sym)?;
		...
		let Byond_LocateXYZ = __library.get(b"_Byond_LocateXYZ\0").map(|sym| *sym)?;
		let Byond_New = __library.get(b"_Byond_New\0").map(|sym| *sym)?;
		let Byond_NewArglist = __library.get(b"_Byond_NewArglist\0").map(|sym| *sym)?;
		let Byond_Refcount = __library.get(b"_Byond_Refcount\0").map(|sym| *sym)?;
		let Byond_XYZ = __library.get(b"_Byond_XYZ\0").map(|sym| *sym)?;
		let Byond_PixLoc = __library.get(b"_Byond_PixLoc\0").map(|sym| *sym)?;
		let Byond_BoundPixLoc = __library.get(b"_Byond_BoundPixLoc\0").map(|sym| *sym)?;
		let ByondValue_IncRef = __library.get(b"_ByondValue_IncRef\0").map(|sym| *sym)?;
		let ByondValue_DecRef = __library.get(b"_ByondValue_DecRef\0").map(|sym| *sym)?;
		let Byond_TestRef = __library.get(b"_Byond_TestRef\0").map(|sym| *sym)?;
		let Byond_CRASH = __library.get(b"_Byond_CRASH\0").map(|sym| *sym)?;
		Ok(ByondApi {
			__library,
			Byond_LastError,
			Byond_SetLastError,
	...
	#[doc = "Gets the last error from a failed call\n If the buffer isn't big enough, it will be \
	         filled as far as it can be, and\n includes a trailing null. Note: This function is \
	         thread-safe, but there is no\n guarantee the error message can't be changed by \
	         another thread between calls.\n Best practice is to use a while() loop to call this \
	         function, reallocating\n the buffer on failure, until success.\n # Arguments\n\n* \
	         `buf` - char array, allocated by caller (can be null if querying length)\n * `buflen` \
	         - Pointer to length of array in bytes; receives the string length\n (including \
	         trailing null)\n # Returns\n\nTrue on success; false if array is not big enough"]
	pub unsafe fn Byond_LastError(
		&self,
		buf: *mut ::std::os::raw::c_char,
		buflen: *mut u4c,
	) -> bool {
	...
	#[doc = "Sets the last error string to a copy of the input\n NULL is treated as an empty \
	         string\n # Arguments\n\n* `err` - The error string"]
	pub unsafe fn Byond_SetLastError(&self, err: *const ::std::os::raw::c_char) {
		(self.Byond_SetLastError)(err)
	}
	...
	#[doc = "# Arguments\n\n* `v` - Pointer to CByondValue\n # Returns\n\nTrue if value is a list \
	         (any list type, not just user-defined)"]
	...
	#[doc = "Fills a CByondValue struct with a floating point number.\n # Arguments\n\n* `v` - \
	         Pointer to CByondValue\n * `f` - Floating point number"]
	pub unsafe fn ByondValue_SetNum(&self, v: *mut CByondValue, f: f32) {
		(self.ByondValue_SetNum)(v, f)
	}
	#[doc = "Creates a string and sets CByondValue to a reference to that string, and\n increases \
	         the reference count. See REFERENCE COUNTING in byondapi.h. Blocks\n if not on the \
	         main thread. If string creation fails, the struct is set to\n null.\n # \
	         Arguments\n\n* `v` - Pointer to CByondValue\n * `str` - Null-terminated UTF-8 \
	         string\n [`Byond_AddGetStrId()`]"]
	...
	#[doc = "Fills a CByondValue struct with a reference to a string with a given ID. Does\n not \
	         validate, and does not increase the reference count. If the strid is\n NONE, it will \
	         be changed to 0.\n # Arguments\n\n* `v` - Pointer to CByondValue\n * `strid` - 4-byte \
	         string ID\n [`Byond_TestRef()`]"]
	...
	#[doc = "Compares two values for equivalence (a ~= b)\n Blocks if not on the main thread, \
	         unless equivalence can be determined\n trivially.\n # Arguments\n\n* `a` - Pointer to \
	         CByondValue\n * `b` - Pointer to CByondValue\n # Returns\n\nTrue if values are equal"]
	pub unsafe fn ByondValue_Equiv(&self, a: *const CByondValue, b: *const CByondValue) -> bool {
		(self.ByondValue_Equiv)(a, b)
	}
	#[doc = "Runs a function as a callback on the main thread (or right away if already\n there) \
	         All references created from Byondapi calls within your callback are\n persistent, not \
	         temporary, even though your callback runs on the main thread.\n Blocking is optional. \
	         If already on the main thread, the block parameter is\n meaningless.\n # \
	         Arguments\n\n* `callback` - Function pointer to CByondValue function(void*)\n * \
	         `data` - Void pointer (argument to function)\n * `block` - True if this call should \
	         block while waiting for the callback to\n finish; false if not\n # \
	...
	#[doc = "Returns a reference to an existing string ID, but does not create a new\n string ID. \
	...
	#[doc = "Returns a reference to an existing string ID or creates a new string ID\n reference. \
	         The new string is reference-counted. See REFERENCE COUNTING in\n byondapi.h for \
	         details. Call ByondValue_SeStrId() to use the returned ID in a\n CByondValue. Blocks \
	...
	#[doc = "Reads an object variable by the string ID of its var name.\n ID can be cached ahead \
	         ...
	         - Object that owns the var\n * `varname` - Var name as string ID\n * `result` - \
	         Pointer to accept result (referenced)\n # Returns\n\nTrue on success\n \
	         [`Byond_GetStrId()`]"]
	...
	#[doc = "Creates an empty list (referenced). Equivalent to list().\n Blocks if not on the main \
	         thread.\n # Arguments\n\n* `result` - Result\n # Returns\n\nTrue on success"]
	pub unsafe fn Byond_CreateList(&self, result: *mut CByondValue) -> bool {
		(self.Byond_CreateList)(result)
	}
	#[doc = "Creates a list (referenced) with a given length. Equivalent to new\n /list(len). \
	         Blocks if not on the main thread.\n # Arguments\n\n* `result` - Result\n * `len` - \
	         Length of new list\n # Returns\n\nTrue on success"]
	pub unsafe fn Byond_CreateListLen(&self, result: *mut CByondValue, len: u4c) -> bool {
		(self.Byond_CreateListLen)(result, len)
	}
	#[doc = "Creates a multi-dimensional list (referenced) with a given size. Equivalent\n to \
	         new/list(sizes[0],sizes[1],...). Blocks if not on the main thread.\n # Arguments\n\n* \
	...
	#[doc = "Reads items (referenced) from a list.\n Blocks if not on the main thread.\n # \
	         Arguments\n\n* `loc` - The list to read\n * `list` - CByondValue array, allocated by \
	         caller (can be null if querying\n length)\n * `len` - Pointer to length of array (in \
	         items); receives the number of\n items read on success, or required length of array \
	...
	#[doc = "Reads items as key,value pairs from an associative list, storing them\n sequentially \
	         as key1, value1, key2, value2, etc. The length of the array is\n always a multiple of \
	         2. Blocks if not on the main thread.\n # Arguments\n\n* `loc` - The list to read\n * \
	         `list` - CByondValue array, allocated by caller (can be null if querying\n length)\n \
	         * `len` - Pointer to length of array (in items); receives the number of\n items read \
	         on success, or required length of array if not big enough\n # Returns\n\nTrue on \
	         success; false with *len=0 for failure; false with\n *len=required size if array is \
	         not big enough"]
	...
	#[doc = "Removes items from a list\n Note: Unlike in DM, if one of the items to remove is a \
	         list itself, this will\n treat it as an item instead of looking at the list's \
	         contents. This call will\n never fail. It will simply return 0 if nothing was \
	         removed. Blocks if not on\n the main thread.\n # Arguments\n\n* `loc` - The list\n * \
	         `items` - An array of items to remove\n * `count` - The number of items\n # \
	         Returns\n\nNumber of items removed"]
	pub unsafe fn Byond_ListRemove(
		&self,
		loc: *const CByondValue,
		items: *const CByondValue,
		count: u4c,
	...
	#[doc = "Calls an object proc by name.\n The proc call is treated as waitfor=0 and will return \
	         immediately on sleep.\n Blocks if not on the main thread.\n # Arguments\n\n* `src` - \
	         The object that owns the proc\n * `name` - Proc name as null-terminated string\n * \
	...
	#[doc = "Calls an object proc by name, where the name is a string ID.\n The proc call is \
	         treated as waitfor=0 and will return immediately on sleep.\n Blocks if not on the \
	         main thread.\n # Arguments\n\n* `src` - The object that owns the proc\n * `name` - \
	         Proc name as string ID\n * `arg` - Array of arguments\n * `arg_count` - Number of \
	         arguments\n * `result` - Pointer to accept result (referenced)\n # Returns\n\nTrue on \
	         success\n [`Byond_GetStrId()`]"]
	...
	#[doc = "Calls a global proc by name.\n The proc call is treated as waitfor=0 and will return \
	         immediately on sleep.\n Blocks if not on the main thread.\n # Arguments\n\n* `name` - \
	         Proc name as null-terminated string\n * `arg` - Array of arguments\n * `arg_count` - \
	         Number of arguments\n * `result` - Pointer to accept result (referenced)\n # \
	         Returns\n\nTrue on success"]
	...
	#[doc = "Uses BYOND's internals to represent a value as text\n If the value isn't already a \
	         string, this acts like the value is embedded in\n a string via brackets. Note: This \
	         means objects with lowercase names get\n \"the\" prepended, and the operator\"\" \
	         overload can be called. Blocks if not on\n the main thread.\n # Arguments\n\n* `src` \
	         - The value to convert to text\n * `buf` - char array, allocated by caller (can be \
	         null if querying length)\n * `buflen` - Pointer to length of array in bytes; receives \
	         the string length\n (including trailing null) on success, or required length of array \
	...
	#[doc = "Returns from a byond,await: call\n Blocks if not on the main thread.\n # \
	         ...
	         if the waiting proc doesn't exist"]
	pub unsafe fn Byond_Return(
		&self,
		waiting_proc: *const CByondValue,
		retval: *const CByondValue,
	) -> bool {
	...
	pub unsafe fn ByondValue_IsType(
		&self,
		src: *const CByondValue,
		typestr: *const ::std::os::raw::c_char,
	) -> bool {
	...
	#[doc = "Equivalent to calling length(src).\n Blocks if not on the main thread.\n # \
	         Arguments\n\n* `src` - The value\n * `result` - Pointer to accept result as a \
	         CByondValue (intended for future\n possible override of length)\n # Returns\n\nTrue \
	         on success"]
	...
	#[doc = "Equivalent to calling locate(type), or locate(type) in list.\n Blocks if not on the \
	         ...
	         locate in; can be a null pointer instead of a\n CByondValue to locate(type) without a \
	         list\n * `result` - Pointer to accept result (referenced); can be null if nothing\n \
	         is found\n # Returns\n\nTrue on success (including if nothing is found); false on \
	         error"]
	...
	#[doc = "Equivalent to calling locate(x,y,z)\n Blocks if not on the main thread.\n Result is \
	         null if coords are invalid.\n # Arguments\n\n* `xyz` - The x,y,z coords\n * `result` \
	         - Pointer to accept result (NOT referenced; is a turf or null)\n # Returns\n\nTrue \
	         (always)"]
	...
	#[doc = "Equivalent to calling new type(arglist)\n Blocks if not on the main thread.\n # \
	         Arguments\n\n* `type` - The type to create (type path or string)\n * `arglist` - \
	         Arguments, as a reference to an arglist\n * `result` - Pointer to accept result \
	         (referenced)\n # Returns\n\nTrue on success"]
	...
	#[doc = "Increase the persistent reference count of an object used in Byondapi\n Reminder: \
	         Calls only create temporary references when made on the main\n thread. On other \
	         threads, the references are already persistent. Blocks if\n not on the main thread.\n \
	...
	#[doc = "Mark a persistent reference as no longer in use by Byondapi\n This is IMPORTANT to \
	         call when you make Byondapi calls on another thread,\n since all the references they \
	         create are persistent. This cannot be used for\n temporary references. See \
	         ByondValue_DecTempRef() for those. Blocks if not on\n the main thread.\n # \
